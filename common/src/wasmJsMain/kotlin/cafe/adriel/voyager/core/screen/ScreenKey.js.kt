...
internal fun randomUuid(): String = uuid4().toString()


// The following is an implementation of benasher44:uuid library: This is necessitated by the move to Kotlin 1.9.20-Beta

fun uuid4(): Uuid = Uuid(getRandomUuidBytes().setVersion(4))

internal fun getRandomUuidBytes(): ByteArray = Random.Default.nextBytes(UUID_BYTES)

internal fun <T> T.freeze(): T = this
...
public val Uuid.bytes: ByteArray
    get() = uuidBytes
