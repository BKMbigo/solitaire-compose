...
import com.github.bkmbigo.solitaire.game.solitaire.moves.SolitaireGameMove.CardMove
import com.github.bkmbigo.solitaire.game.solitaire.moves.SolitaireGameMove.Deal
...
/** A Solitaire game move. Can either be a [Deal] or a [CardMove].*/
sealed class SolitaireGameMove(
    override val time: Instant = Clock.System.now()
) : GameMove {

    object Deal : SolitaireGameMove() {
        override fun isValid(): Boolean = true
    }

    /* Decouple game from [Solitaire Game Move]*/
    data class CardMove(
            ...
            *           - Table stacks are valid */
            ...
            when (from) {
                MoveSource.FromDeck -> {
                    ...
                    if (!game.deck.contains(cards.first())) return false
                }
